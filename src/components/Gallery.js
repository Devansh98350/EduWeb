...
import i00 from "../assets/gallery/i00.jpg";
import i01 from "../assets/gallery/i01.jpg";
import i02 from "../assets/gallery/i02.jpg";
import i03 from "../assets/gallery/i03.jpg";
import i04 from "../assets/gallery/i04.jpg";
    ...
    <>
      <Layout title="Gallery-IIT Academy">
        <div className="row9 m-0">
          ...
          {/* <div className="column9">
            <div className="img" data-aos="fade-right">
              <img src="assets/img/gallery/p7.jpg" alt="" />
              <div className="overlay"></div>
            </div>
