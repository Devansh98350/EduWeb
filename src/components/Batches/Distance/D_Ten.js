...
import "./Distance.css";
import img from "../../../assets/batches/Sankalp.webp";
        ...
        <section id="section">
          ...
          <div className="about">
            ...
            <p>
              ...
              ></i>
              Sankalp is a comprehensive online course specifically designed for
              class 10 students to help them excel in their board exams and
          ...
          <div className="details" id="details">
            ...
            <div className="detail-box">
              <h5 className="heading-box">
                Fee Structure For SANKALP Course (1 Year)
              </h5>
