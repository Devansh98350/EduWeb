...
import "./Distance.css";
import img from "../../../assets/batches/Abhiyaan.webp";
        ...
        <section>
          ...
          <div className="about">
            ...
            <p>
              ...
              ></i>
              Abhiyaan Course is specially designed of students who would be
              taking their Class XII board exams in 2024 and are willing to
              dedicate one year for the preparation of JEE-Advanced 2025. This
              course has been designed for students who intend to retake
              JEE(Main+Advance) in 2025 for a better rank. It is also of utmost
              importance for those students who have not undergone specialized
              Coaching/ Training for JEE (Main+Advanced) during their Class XI &
              XII.
            </p>
            <p>
              <i
              ...
              in online medium from the comfort of home.
            </p>
            <p>
              <i
                className="fas fa-angle-double-right"
                style={{ color: "#f39c12", marginRight: "5px" }}
              ></i>
              Students joining this program are mentored to do focussed study
              for one year to utilise remaining time for preparation of JEE
          ...
          <div className="details" id="details">
            ...
            <div className="detail-box">
              <h5 className="heading-box">
                Fee Structure For ABHIYAAN Course (1 Year)
              </h5>
