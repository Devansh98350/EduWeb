        ...
        <section id="section">
          ...
          <div className="about">
            ...
            <p>
              ...
              ></i>
              Daksh course is designed for the students who want to command in
              Class 11th (PCB). This course will build a strong foundation of
          ...
          <div className="details" id="details">
            ...
            <div className="detail-box">
              <h5 className="heading-box">
                Fee Structure For DAKSH Course (1 Year)
              </h5>
