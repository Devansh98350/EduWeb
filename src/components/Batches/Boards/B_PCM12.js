...
import "./Boards.css";
import img from "../../../assets/batches/Vikash.webp";
        ...
        <section id="section">
          ...
          <div className="about">
            ...
            <p>
              ...
              ></i>
              Vikash course is designed for the students who want to command in
              Class 12th (PCM). This course will provide complete preparation
              for Board Exams.
            </p>
            <p>
              <i
          ...
          <div className="details" id="details">
            ...
            <div className="detail-box">
              <h5 className="heading-box">
                Fee Structure For VIKASH Course (1 Year)
              </h5>
