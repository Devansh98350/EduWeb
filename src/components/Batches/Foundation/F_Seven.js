...
import img from "../../../assets/batches/Abhinav.webp";
        ...
        <section>
          ...
          <div className="about">
            ...
            <p>
              ...
              ></i>
              Abhinav Course is specially designed for class 7th students to
              give them extra edge preparation for the various Olympiads &
              nurturing the students like a bud and flourish them by making them
              to participate.
            </p>
            <p>
              <i
          ...
          <div className="details" id="details">
            ...
            <div className="detail-box">
              <h5 className="heading-box">
                Fee Structure For ABHINAV Course (1 Year)
              </h5>
