    ...
    <I18nextProvider i18n={i18n}>
      ...
      <Router>
        <Routes>
          ...
          />
          <Route
            path="/engineering-class-13-iit-academy"
            element={<Eklavya />}
          />
          ...
          <Route
            path="/foundation-class-07-iit-academy"
            element={<Abhinav />}
          />
          <Route path="/foundation-class-08-iit-academy" element={<Abhyas />} />
          <Route
            path="/foundation-class-09-iit-academy"
            element={<Aarohan />}
          />
          ...
          />
          <Route
            path="/distance-class-11-med-iit-academy"
            element={<Yukti />}
          />
          <Route
          ...
          {/* Login Section */}
          <Route
            path="/students-login-iit-academy"
            element={<StudentLogin />}
          />
          <Route path="/faculty-login-iit-academy" element={<FacultyLogin />} />
          {/* Other */}
          <Route
            path="/admission-form-iit-academy"
